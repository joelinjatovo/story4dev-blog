...
class Settings{
    ...
    public static function get_pages() {
        if ( empty( self::$settings ) ) {
            ...
            self::$settings = apply_filters( 'story4dev_get_settings_pages', $settings );
        }
    ...
    public static function save() {
        ...
        do_action( 'story4dev_settings_saved' );
    }
    ...
    public static function output() {
        ...
        $tabs = apply_filters( 'story4dev_settings_tabs_array', array() );

        include S4D_DIR . '/template/admin/settings.php';
    }
            ...
            switch ( $value['type'] ) {
                ...
                case 'single_select_page':
                    ...
                    <tr valign="top" class="single_select_page">
                        ...
                        <td class="forminp">
                            <?php echo str_replace( ' id=', " data-placeholder='" . esc_attr__( 'Select a page&hellip;', 'story4dev' ) . "' style='" . $value['css'] . "' class='" . $value['class'] . "' id=", wp_dropdown_pages( $args ) ); // WPCS: XSS ok. ?> <?php echo $description; // WPCS: XSS ok. ?>
                        </td>
                    </tr>
                    <?php
                    break;
                ...
                default:
                    do_action( 'story4dev_admin_field_' . $value['type'], $value );
                    break;
            }
        }
    }
    ...
    public static function save_fields( $options, $data = null ) {
        ...
        foreach ( $options as $option ) {
             ...
             * @since 2.4.0
             */
            $value = apply_filters( 'story4dev_admin_settings_sanitize_option', $value, $option, $raw_value );
             ...
             * @since 2.4.0
             */
            $value = apply_filters( "story4dev_admin_settings_sanitize_option_$option_name", $value, $option, $raw_value );
             ...
             */
            do_action( 'story4dev_update_option', $option );
        }
